...
#
#   BOUKENSHA_PATH  which *step* lib to load  (default: the lib bundled in this gem)
...
#
# Examples:
#   boukensha                                                        # bundled lib + configured dir
#   BOUKENSHA_PATH=~/Sites/boukensha/04_api_client boukensha         # loads step 4
#   BOUKENSHA_DIR=~/projects/mybot/.boukensha boukensha              # config dir for one run
